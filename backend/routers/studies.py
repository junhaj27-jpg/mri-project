...
def seed_studies(db: Session = Depends(get_db)):
    seed_rows = [
        {"study_label": "T01", "event_type": "surgery_follow_up", "section": "T01~T04", "hospital_alias": "HOSP_A", "volume_cm3": 52.8, "preview_url": "/media/slices/P001/T01/preview_slice.png", "overlay_url": "/media/overlays/P001/T01/overlay.png"},
        ...
        {"study_label": "T05", "event_type": "hospital_transition", "section": "T04~T05", "hospital_alias": "HOSP_B", "volume_cm3": 44.9, "memo": "장비/병원 변경 가능성이 있어 직접 치료효과 판단 제외"},
        ...
        {"study_label": "T08", "event_type": "post_gamma_knife_follow_up", "section": "T08 이후", "hospital_alias": "HOSP_B", "volume_cm3": 39.4, "change_cm3": -2.6, "change_rate_percent": -6.19, "model_3d_url": "/media/models/P001/T08/lesion_model.glb", "preview_url": "/media/slices/P001/T08/preview_slice.png", "overlay_url": "/media/overlays/P001/T08/overlay.png"},
    ...
    for row in seed_rows:
        if not db.query(Study).filter(Study.study_label == row["study_label"]).first():
            db.add(Study(patient_code="P001", **row))
    db.commit()
    return db.query(Study).order_by(Study.study_label.asc()).all()
